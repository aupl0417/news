...
//dump($data->items());die;
    ...
    public function add()
    {
        ...
        $articleThemeFiles = $themeModel->getActionThemeFiles('portal/Index/index');//portal/Article/index
    ...
    public function addPost()
    {
        if ($this->request->isPost()) {
            ...
            $this->pushBaidu($portalPostModel->id,'add');
    ...
    public function editPost()
    {
        ...
        if ($this->request->isPost()) {
            ...
            $this->pushBaidu($data['post']['id'],'edit');
            $this->success('保存成功!');
    ...
    //百度新闻主动推送（实时）
    public function pushBaidu($id,$type='add'){
        if (empty($id)){
            return false;
        }
        $urls = array();
        $urls[]=url("/detail/$id",'','',true);

        switch ($type){
            case 'add':
                $api = 'http://data.zz.baidu.com/urls?site=https://dtzs.dttx.com&token=OQoN6XQ29pCiOzq2';
                break;
            case 'edit':
                $api = 'http://data.zz.baidu.com/update?site=https://dtzs.dttx.com&token=OQoN6XQ29pCiOzq2';
                break;
            case 'del':
                $api = 'http://data.zz.baidu.com/del?site=https://dtzs.dttx.com&token=OQoN6XQ29pCiOzq2';
                break;
            default:
                $api = 'http://data.zz.baidu.com/urls?site=https://dtzs.dttx.com&token=OQoN6XQ29pCiOzq2';
        }
